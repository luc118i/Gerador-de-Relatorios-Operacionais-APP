...
export const OccurrenceBoardCard = memo(function OccurrenceBoardCard({
  ...
  return (
    <div
      ...
      className={`group relative flex min-h-[66px] w-full cursor-pointer flex-col justify-center rounded-md border ${cardTint} pr-10 text-left transition-[transform,border-color,opacity,box-shadow] duration-150 hover:-translate-y-px focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/60 ${
