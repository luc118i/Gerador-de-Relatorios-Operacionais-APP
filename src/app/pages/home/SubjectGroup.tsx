  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-2">
        ...
        {isAdmin && !anyBatchRunning && unregistered.length > 0 && (
          <button
            ...
            className="cursor-pointer inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-950/40 transition-colors"
          >
        ...
        {isAdmin && !anyBatchRunning && registered.length > 0 && (
          <button
            ...
            className="cursor-pointer inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-950/40 transition-colors"
          >
      ...
      {registroBatch.running && (
        <div className="mb-2 flex items-center gap-3 px-3 py-2 bg-orange-50 dark:bg-orange-950/40 border border-orange-200 dark:border-orange-800 rounded-lg">
          ...
          {!registroBatch.cancelRequested && (
            <button
              ...
              className="cursor-pointer flex items-center gap-1 text-[10px] font-medium text-orange-500 hover:text-orange-700 dark:hover:text-orange-400 transition-colors"
            >
      ...
      {tratativaBatch.running && (
        <div className="mb-2 flex items-center gap-3 px-3 py-2 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-lg">
          ...
          {!tratativaBatch.cancelRequested && (
            <button
              ...
              className="cursor-pointer flex items-center gap-1 text-[10px] font-medium text-amber-500 hover:text-amber-700 dark:hover:text-amber-400 transition-colors"
            >
              <X className="w-3 h-3" /> Cancelar
            </button>
          )}
      ...
      {revisarBatch.running && (
        <div className="mb-2 flex items-center gap-3 px-3 py-2 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 rounded-lg">
          ...
          {!revisarBatch.cancelRequested && (
            <button
              ...
              className="cursor-pointer flex items-center gap-1 text-[10px] font-medium text-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors"
            >
              <X className="w-3 h-3" /> Cancelar
            </button>
          )}
