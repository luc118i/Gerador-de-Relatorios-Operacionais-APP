...
export function HomeHeader({
  ...
  return (
    <header
      className={`relative z-10 bg-[#d9d9d9] dark:bg-gray-900 border-t-[1.5px] border-t-white/85 dark:border-t-0 dark:border-b dark:border-gray-800 transition-shadow duration-500 ease-out dark:shadow-none ${
        scrolled
