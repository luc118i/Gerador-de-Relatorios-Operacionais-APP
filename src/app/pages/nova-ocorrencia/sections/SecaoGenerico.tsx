...
export function SecaoGenerico({
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-top-2 duration-300">
      {/* Nome do Relatório — sempre visível */}
      <section>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                value={ccoOperator}
                onChange={(e) => onCcoOperatorChange(e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                min={0}
                value={vehicleKm ?? ""}
                onChange={(e) => onVehicleKmChange(e.target.value ? Number(e.target.value) : null)}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => onPassengerCountChange(e.target.value ? Number(e.target.value) : null)}
                placeholder="Ex: 15"
                className={inputBase}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => onPassengerConnectionChange(e.target.value)}
                placeholder="Ex: 3 ou —"
                className={inputBase}
              />
            </div>
        ...
        <div className="space-y-3">
          <div>
            ...
            <select
              ...
              onChange={(e) => onDevolutivaStatusChange(e.target.value)}
