...
const TRATATIVA_OPTIONS: {
  ...
  },
  {
    ...
    dot: "bg-amber-400",
    badge: "bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800",
  },
  {
    value: "VALE",
    label: "Vale",
    ...
    dot: "bg-red-500",
    badge: "bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800",
  },
  {
    value: "REGISTRO",
    label: "Só o Registro",
    ...
    dot: "bg-gray-400",
    badge: "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-800",
  },
];
      ...
      <div className="grid grid-cols-2 gap-4">
                ...
                <SelectItem key={opt.value} value={opt.value}>
                  <span className="flex items-center gap-2.5 py-0.5">
                    ...
                    <span className="flex flex-col">
                      ...
                      <span className="text-[11px] text-gray-400 dark:text-gray-500 mt-0.5 pl-0.5">
                        {opt.description}
                      </span>
                    </span>
                  </span>
        ...
        <div>
          ...
          <div className="relative">
            <UserCheck className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none" />
            <input
              type="text"
              value={analisadoPor}
